...
Clockwork.option:SetKey("description_business", "Commandez des articles pour votre entreprise.")
Clockwork.option:SetKey("description_inventory", "Gérez les articles dans votre inventaire.")
Clockwork.option:SetKey("description_directory", "Tous les liens vers le manifeste.")
Clockwork.option:SetKey("description_system", "Accédez à une variété d'options côté serveur.")
Clockwork.option:SetKey("description_scoreboard", "Voir quels joueurs sont sur le serveur.")
Clockwork.option:SetKey("description_attributes", "Vérifiez l'état de vos attributs.")
